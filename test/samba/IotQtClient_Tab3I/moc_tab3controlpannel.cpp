...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Tab3ControlPannel_t, stringdata) + ofs \
...
void Tab3ControlPannel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Tab3ControlPannel *_t = static_cast<Tab3ControlPannel *>(_o);
        switch (_id) {
        ...
        {
            typedef void (Tab3ControlPannel::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Tab3ControlPannel::sigSocketSendData)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Tab3ControlPannel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Tab3ControlPannel.data,
      qt_meta_data_Tab3ControlPannel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tab3ControlPannel.stringdata))
        return static_cast<void*>(const_cast< Tab3ControlPannel*>(this));
