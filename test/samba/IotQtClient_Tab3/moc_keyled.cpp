...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_KeyLed_t, stringdata) + ofs \
...
void KeyLed::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        KeyLed *_t = static_cast<KeyLed *>(_o);
        switch (_id) {
        ...
        {
            typedef void (KeyLed::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyLed::updateKeydataSig)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject KeyLed::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_KeyLed.data,
      qt_meta_data_KeyLed,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_KeyLed.stringdata))
        return static_cast<void*>(const_cast< KeyLed*>(this));
